	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><select name="subjectId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择学科'">
                    <c:forEach items="${subjectList }" var="subject">
                        <option value="${subject.id }">${subject.name }</option>
                    </c:forEach>
                </select>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">所属学科专业:</td>
                <td><select id="edit-subjectId" name="subjectId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择学科'">
                    <c:forEach items="${subjectList }" var="subject">
                        <option value="${subject.id }">${subject.name }</option>
                    </c:forEach>
                </select>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
            ...
            { field:'name',title:'考生登陆名',width:100,sortable:true},
            { field:'subjectId',title:'所属学科',width:200,formatter:function (value,index,row) {
            ...
            { field:'password',title:'考生登录密码',width:200},
