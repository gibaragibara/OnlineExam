...
<div class="tm_register_container">
        ...
        <form action="http://demo.tomexam.com/" id="form_register" method="post">
            <table border="0" cellpadding="5" cellspacing="0" class="tm_register_table">
                ...
                <tr>
                    <th>用户名</th>
                    <td>
                        <input type="text" class="validate[required,minSize[3]] tm_txt"
                               name="name" maxlength="30" value="" style="width:200px">
                ...
                <tr>
                    <th>真实姓名</th>
                    <td>
                        <input type="text" name="truename" class="tm_txt" size="50" maxlength="30"
                               style="width:200px">
                    </td>
                </tr>
                <tr>
    ...
    <div class="tm_register_foot">
        ...
        <div>All Rights Reserved, Copyright (C) 2020, jubei, Ltd.</div>
    </div>
</div>
