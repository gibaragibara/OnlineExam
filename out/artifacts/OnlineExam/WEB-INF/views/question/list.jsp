    ...
    <form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><select name="questionType" class="easyui-combobox" panelHeight="auto" style="width:268px"
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
    ...
    <form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">所属类型:</td>
                <td><select id="edit-questionType" name="questionType" class="easyui-combobox" panelHeight="auto"
                            style="width:268px"
                            data-options="required:true, missingMessage:'请选择试题类型'">
                    <option value="0">单选</option>
                    <option value="1">多选</option>
    ...
    <table>
        <tr>
            ...
            <td><input type="text" id="import-filename" name="filename" class="wu-text easyui-validatebox"
                       readonly="readonly "
                       data-options="required:true, missingMessage:'请选择文件'"></td>
            <td><a onclick="uploadFile()" href="javascript:void(0)" id="select-file" class="easyui-linkbutton"
                   iconCls="icon-upload">选择文件</a></td>
        </tr>
        <tr>
            <td align="right">所属科目:</td>
            <td><select id="import-subjectId" name="subjectId" class="easyui-combobox" panelHeight="auto" style="width:268px"
                        data-options="required:true, missingMessage:'请选择考试科目'">
                <c:forEach items="${subjectList }" var="subject">
                    <option value="${subject.id }">${subject.name }</option>
                </c:forEach>
