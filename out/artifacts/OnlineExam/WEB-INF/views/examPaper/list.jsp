    ...
    <form id="edit-form" method="post">
        ...
        <table>
            <tr>
                ...
                <td><select id="edit-examId" name="examId" class="easyui-combobox" panelHeight="auto"
                            style="width:268px"
            ...
            <tr>
                ...
                <td><select id="edit-studentId" name="studentId" class="easyui-combobox" panelHeight="auto"
                            style="width:268px"
                            data-options="required:true, missingMessage:'请选择试卷科目'">
                    <c:forEach items="${studentList }" var="student">
                        <option value="${student.id }">${student.name }</option>
