    ...
    <form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><select name="subjectId" class="easyui-combobox" panelHeight="auto" style="width:268px"
            ...
            <tr>
                ...
                <td><input type="text" id="add-startTime" name="startTime"
                           class="wu-text easyui-datetimebox easyui-validatebox"
                           editable="false"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="add-availableTime" name="availableTime"
                           class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写考试考试限制时间'">
                </td>
            </tr>
            <tr>
                <td align="right">及格分数线:</td>
                <td><input type="text" id="add-passScore" name="passScore" class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写及格分数线'"></td>
            </tr>
            <tr>
                <td align="right">单选题数量:</td>
                <td><input type="text" id="add-singleQuestionNum" name="singleQuestionNum"
                           placeholder="每个单选题${singleScore}分"
                           class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试单选题数量'">
                </td>
            </tr>
            <tr>
                <td align="right">多选题数量:</td>
                <td><input type="text" id="add-muiltQuestionNum" name="muiltQuestionNum"
                           placeholder="每个多选题${muiltScore}分"
                           class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试多选题数量'">
                </td>
            </tr>
            <tr>
                <td align="right">判断题数量:</td>
                <td><input type="text" id="add-chargeQuestionNum" name="chargeQuestionNum"
                           placeholder="每个判断题${chargeScore}分"
                           class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试判断题数量'">
                </td>
            </tr>
        </table>
    </form>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
    ...
    <form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">所属科目:</td>
                <td><select id="edit-subjectId" name="subjectId" class="easyui-combobox" panelHeight="auto" style="width:268px"
                            data-options="required:true, missingMessage:'请选择考试科目'">
                    <c:forEach items="${subjectList }" var="subject">
                        <option value="${subject.id }">${subject.name }</option>
                    </c:forEach>
            ...
            <tr>
                <td align="right">考试限制时间:</td>
                <td><input type="text" id="edit-availableTime" name="availableTime"
                           class="wu-text easyui-validatebox"
                           data-options="required:true, missingMessage:'请填写考试考试限制时间'">
                </td>
            </tr>
            ...
            <tr>
                <td align="right">单选题数量:</td>
                <td><input type="text" id="edit-singleQuestionNum" name="singleQuestionNum"
                           class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试单选题数量'">
                </td>
            </tr>
            <tr>
                <td align="right">多选题数量:</td>
                <td><input type="text" id="edit-muiltQuestionNum" name="muiltQuestionNum"
                           class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试多选题数量'">
                </td>
            </tr>
            <tr>
                <td align="right">判断题数量:</td>
                <td><input type="text" id="edit-chargeQuestionNum" name="chargeQuestionNum"
                           class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试判断题数量'">
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
    ...
    function edit() {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.type == 'success') {
                    $.messager.alert('信息提示', '修改成功成功！', 'info');
                    $("#edit-name").val('');
                    $("#edit-remark").val('');
                    $('#edit-dialog').dialog('close');
                    $('#data-datagrid').datagrid('reload');
     ...
     */
    function remove() {
        $.messager.confirm('信息提示', '确定要删除该考试？', function (result) {
            if (result) {
                var item = $('#data-datagrid').datagrid('getSelected');
                if (item == null || item.length == 0) {
    ...
    $('#data-datagrid').datagrid({
        ...
        columns: [[
            ...
            {
                field: 'startTime', title: '考试开始时间', width: 200, formatter: function (value, index, row) {
                    return format(value);
                }
            },
            {
                field: 'endTime', title: '考试结束时间', width: 200, formatter: function (value, index, row) {
                    return format(value);
                }
            },
            {
                field: 'availableTime', title: '考试限制时间', width: 200,formatter: function (value, index, row) {
                    return value+"分钟";
                }
            },
            {field: 'questionNum', title: '试题总数', width: 200},
            ...
            {field: 'paperNum', title: '生成试卷数量', width: 200},
