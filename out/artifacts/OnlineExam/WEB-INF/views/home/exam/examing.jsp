                    ...
                    <div class="test_title">
                        <p class="test_time">
                            <img style="float:left;margin-top: 15px;margin-left: 10px"
                                ...
                                class="alt-1">${hour}:${minite}:${second}</b>
                        </p>
                            ...
                            <ul>
                                <c:forEach items="${muiltQuestionList}" var="mq" varStatus="mqids">
                                    <li id="qu_${muiltQuestion}_${mq.question.id}" data-key="${mq.id}">
                                        <div class="test_content_nr_tt">
                                            <i>${exam.singleQuestionNum + mqids.index + 1}</i><span>(${muiltScore}分)</span><font>${mq.question.title}</font>
                                        </div>
                                        ...
                                        <div class="test_content_nr_main">
                                            <ul>
                                                ...
                                                <li class="option" data-type="muilt" data-value="A">
                                                    ...
                                                    <input type="checkbox" class="radioOrCheck" name="answer${mq.id}"
                                                           value="A"
                                                           id="${muiltQuestion}_answer_${mq.id}_option_1"
                                                    />
                                                ...
                                                <li class="option" data-type="muilt" data-value="C">
                                                    ...
                                                    <input type="checkbox" class="radioOrCheck" name="answer${mq.id}"
                                                           value="C"
                                                           id="${muiltQuestion}_answer_${mq.id}_option_3"
                                                    />
                                                ...
                                                <li class="option" data-type="muilt" data-value="D">
                                                    ...
                                                    <input type="checkbox" class="radioOrCheck" name="answer${mq.id}"
                                                           value="D"
                                                           id="${muiltQuestion}_answer_${mq.id}_option_4"
                                                    />
                            ...
                            <ul>
                                <c:forEach items="${chargeQuestionList}" var="cq" varStatus="cqids">
                                    <li id="qu_${chargeQuestion}_${cq.question.id}" data-key="${cq.id}">
                                        <div class="test_content_nr_tt">
                                            <i>${exam.singleQuestionNum +exam.muiltQuestionNum +cqids.index+1}</i><span>(${cq.question.score}分)</span><font>${cq.question.title}</font>
                                        </div>
            ...
            <div class="nr_rt_main">
                <div class="rt_nr1">
                    <div class="rt_nr1_title">
                        <h1>
                            <img style="float:left;margin-top: 15px;margin-left: 10px"
                                 src="../../resources/home/exam/images/edit.png" width="16px">答题卡
                        </h1>
                        <p class="test_time">
                            <img style="float:left;margin-top: 15px;margin-left: 10px"
                                 src="../../resources/home/exam/images/time.png" width="16px"><b
                            ...
                            <div class="rt_content_nr answerSheet">
                                <ul>
                                    <c:forEach items="${chargeQuestionList}" var="ccq" varStatus="ccqids">
                                        <li>
                                            <a href="#qu_${chargeQuestion}_${ccq.question.id}">${ccqids.index+exam.singleQuestionNum+1+exam.muiltQuestionNum}</a>
                                        </li>
                                    </c:forEach>
...
<script>
    ...
    function submitExam() {
        autoSubmit = true;
        var wcm = window.confirm("提交后将无法修改，确认提交考试？");
        if (!wcm) {
            return;
        }
        //提交试卷
        $.ajax({
            ...
            success: function (data) {
                if (data.type == 'success') {
                    alert("考试成绩已出，请到用户中心查看")
                    top.window.location = "../user/index";
                } else if (data.type == 'error') {
                    alert(data.msg);
                    //$(".tm_btn_primary").text('提交');
                    //return;
