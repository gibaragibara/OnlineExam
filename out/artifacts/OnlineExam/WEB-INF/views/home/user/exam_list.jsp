            ...
            <table width="100%" cellpadding="10" border="0" class="tm_table_list">
                ...
                <c:forEach items="${examList}" var="exam">
                    <tr id="tr-${exam.id }" data-key="${exam.id}">
                        <td>${exam.name}</td>
                        <td><fmt:formatDate value="${exam.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            ---
                            <fmt:formatDate value="${exam.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                        <td>${exam.availableTime}</td>
                        <td>${subject.name}</td>
            ...
            <tr>
                <td>
                    <div class="tm_pager_foot">
                        <a href="exam_list?page=${page - 1}" class="tm_btns" style="color:white;text-decoration:none;">上一页</a>&nbsp&nbsp${page}&nbsp&nbsp<a
                            href="exam_list?page=${page +1}"
                            class="tm_btns"
...
<script type="text/javascript">
    ...
    var tm = {
        startExam: function (e) {
            ...
            html.push('<button  class="tm_btn tm_btn_primary confir-exam" type="button" onclick="tm.joinExam(\'' + eid + '\')">确定</button>');
            html.push('</p>');
